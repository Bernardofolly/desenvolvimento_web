...
$filtro = array_filter($pessoas, function($pessoas, $idade){
  calculaIdade($pessoas['dtNascimento']);
  if(stripos($pessoas["nome"], $_POST['nome']) > -1 && 
  stripos($pessoas["cidade"], $_POST['cidade']) > -1 && 
  $pessoas["estado"] == $_POST['estado'] && 
  $idade == $_POST['idade'])
  {
      return true;
  }
